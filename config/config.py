...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002159303069"))

# A name for your Music bot.
MUSIC_BOT_NAME = getenv("ALYA_MUSIC_BOT")

# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "5585016974").split())
...
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/Anime_sub_society")
...
# Images
START_IMG_URL = getenv("START_IMG_URL", "https://graph.org/file/7e7c0564bfb98e9ec652f.jpg")
